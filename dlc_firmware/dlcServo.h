/*
  dlcServo.h - Interrupt driven Servo library for Arduino using 16 bit timers - Version 2
...
/*
  A servo is activated by creating an instance of the dlcServo class passing
  ...
  The methods are:
    ...
    dlcServo - Class for manipulating servo motors connected to Arduino pins.

    attach(pin ) - Attaches a servo motor to an I/O pin.
    attach(pin, min, max  ) - Attaches to a pin setting min and max values in microseconds
    default min is 500, max is 2500
...
#else
#error "This library only supports boards with an AVR, SAM, SAMD, or XMC processor."
#endif

#define dlcServo_VERSION           2     // software version of this library
